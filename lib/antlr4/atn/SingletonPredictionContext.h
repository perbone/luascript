...
namespace atn {
  ...
  public:
    ...
    const __Ref<PredictionContext> parent;
    const size_t returnState;

    SingletonPredictionContext(__Ref<PredictionContext> const& parent, size_t returnState);
    virtual ~SingletonPredictionContext();

    static __Ref<SingletonPredictionContext> create(__Ref<PredictionContext> const& parent, size_t returnState);

    virtual size_t size() const override;
    virtual __Ref<PredictionContext> getParent(size_t index) const override;
